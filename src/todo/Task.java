...
//        
//		Task t1 = new Task("M�ll rausbringen", LocalDate.now(), 2, Color.red, "Gr�ne und schwarze Tonne sind dran.");
//		Task t2 = new Task("W�sche waschen", LocalDate.now(), 2, Color.green, "Buntw�sche.");
//		Task t3 = new Task("Blumen gie�en", LocalDate.now(), 2, Color.blue, "Auch an Tomaten denken.");
//		frame.add(t1);
//		frame.add(t2);
//		frame.add(t3);
//		frame.pack();
